...
// 读取parking-games-data.js文件
const parkingGamesDataPath = path.join(__dirname, 'js', 'data', 'parking-games-data.js');
const parkingGamesDataContent = fs.readFileSync(parkingGamesDataPath, 'utf8');

// 提取游戏数据
const gamesDataMatch = parkingGamesDataContent.match(/var parkingGamesData = \[(.*?)\];/s);
if (!gamesDataMatch) {
...
// 确保parking目录存在
const parkingDir = path.join(__dirname, 'parking');
...
const generatePage = (game) => {
    ...
    const filePath = path.join(parkingDir, `${safeFileName}.html`);
...
<head>
    ...
    <link rel="canonical" href="https://trafficgames.com/parking/${safeFileName}.html" />
...
<body>
            ...
            <div class="detail-container">
                <div class="detail-content">
                    <div class="detail-block">
                        <h2 class="detail-title">${gameName} - Master the Art of Parking</h2>
                        <p class="detail-description" id="objectiveText">Play ${gameName}, an exciting parking game that challenges you to master the art of precision parking. Navigate through challenging parking lots and complete various parking tasks.</p>
                        <p>${gameName} offers a thrilling parking experience with its realistic controls and challenging scenarios. Perfect for fans of parking simulation games, this game combines skill, precision, and excitement in every mission.</p>
                    </div>

                    <div class="detail-block">
                        <h2 class="detail-title">How to Play ${gameName}</h2>
                        <p>In ${gameName}, your goal is to complete various parking tasks with precision and skill. Use the arrow keys or WASD to control your vehicle, and use the spacebar for braking. Navigate through challenging parking lots, avoid obstacles, and park your vehicle in the designated spot to complete each level.</p>
                        <p>As you progress, you'll encounter more challenging parking scenarios with increasing difficulty. The game features realistic physics and responsive controls, allowing you to navigate tight spaces and challenging parking situations. Pay attention to the parking guidelines and avoid hitting other vehicles or obstacles to succeed.</p>
                    </div>

                    <div class="detail-block">
                        <h2 class="detail-title">Features of ${gameName}</h2>
                        <p>${gameName} offers a range of features that make it one of the most exciting parking games available online. These include:</p>
                        <ul>
                            <li>Realistic parking physics and controls</li>
                            <li>Multiple challenging parking scenarios</li>
                            <li>A variety of vehicles to park</li>
                            <li>Detailed parking lots and environments</li>
                            <li>Progressive difficulty levels</li>
                        </ul>
                        <p>Whether you're a seasoned parking game veteran or a casual player looking for some parking fun, ${gameName} offers an engaging parking experience that will keep you coming back for more. So get behind the wheel and start parking!</p>
                    </div>

                    <div class="detail-block seo-only">
                        <h2 class="detail-title">${gameName}</h2>
    ...
    <script src="../js/parking/${safeFileName}-data.js"></script>
